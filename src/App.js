...
class BooksApp extends React.Component {
    ...
    componentWillMount() {
        if (!localStorage.data) {
            ...
            localStorage.data = JSON.stringify(this.appData);
              ...
              <div className="list-books">
                ...
                <div className="list-books-content">
                  <div>
                    ...
                    <Bookshelf onMoveBook={this.moveBook} shelf={'Currently reading'} list={this.state.bookList}
                    />

                    <Bookshelf onMoveBook={this.moveBook} shelf={'Want to read'} list={this.state.bookList}
                    />

                    <Bookshelf onMoveBook={this.moveBook} shelf={'Read'} list={this.state.bookList}
                    />
